...
export const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-5rem)] bg-[oklch(0.2077_0.0398_265.7549)] flex items-center justify-center px-4 py-12 relative overflow-hidden">
      {/* Signature Trolly Glow */}
      <div className="trolly-glow w-96 h-96 -top-12 left-1/2 -translate-x-1/2 opacity-70"></div>

      {/* Login Card */}
      <div className="w-full max-w-md bg-[oklch(0.2795_0.0368_260.0310)] border border-slate-700/80 rounded-2xl p-8 shadow-2xl relative z-10 animate-fade-in-up">
        <div className="mb-8 text-center sm:text-left">
          <h1 className="font-serif text-3xl font-bold text-slate-100 mb-2">
            Welcome back.
          </h1>
          <p className="text-sm font-sans text-slate-400">
            Sign in to access your TrollyWise demo requests.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5 font-sans">
          ...
          <button
            ...
            className="w-full py-4 rounded-xl bg-emerald-400 text-slate-950 font-semibold text-sm hover:bg-emerald-300 focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:ring-offset-2 focus:ring-offset-slate-900 transition-all flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(124,255,212,0.15)] disabled:opacity-50"
          >
            {isSubmitting ? (
        ...
        <div className="mt-8 pt-6 border-t border-slate-800 text-center text-xs text-slate-400 font-sans">
