...
export const BookingPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Direct redirect to payment step (FR-3.5)
  ...
  return (
    <div className="min-h-[calc(100vh-5rem)] bg-[oklch(0.2077_0.0398_265.7549)] py-12 px-4 relative overflow-hidden flex items-center justify-center">
      {/* Trolly Glow Backdrop */}
      <div className="trolly-glow w-[450px] h-[450px] -top-10 left-1/2 -translate-x-1/2 opacity-50"></div>

      <div className="w-full max-w-xl bg-[oklch(0.2795_0.0368_260.0310)] border border-slate-700/80 rounded-2xl p-8 sm:p-10 shadow-2xl relative z-10 animate-fade-in-up">
        {/* Stepper indicator */}
        <div className="flex items-center gap-2 mb-6">
          <div className="w-2.5 h-2.5 rounded-full bg-emerald-400"></div>
          <div className="w-8 h-0.5 bg-slate-700"></div>
          <div className="w-2.5 h-2.5 rounded-full bg-slate-700"></div>
          <span className="text-[11px] font-mono text-slate-400 uppercase tracking-widest ml-2">
